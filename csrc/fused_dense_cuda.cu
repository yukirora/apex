                ...
                bool use_bias, const void* bias)
{
  ...
  printf("gemm_bias_lt-half:2\n");

  if (use_bias)  {
    checkCublasStatus(cublasLtMatmulDescSetAttribute(operationDesc, CUBLASLT_MATMUL_DESC_BIAS_POINTER, &bias, sizeof(bias)));
    epilogue = CUBLASLT_EPILOGUE_BIAS;
  }
  printf("gemm_bias_lt-half:3\n");
  checkCublasStatus(cublasLtMatmulDescSetAttribute(operationDesc, CUBLASLT_MATMUL_DESC_EPILOGUE, &epilogue, sizeof(epilogue)));
  checkCublasStatus(cublasLtMatmulDescSetAttribute(operationDesc, CUBLASLT_MATMUL_DESC_TRANSA, &transa, sizeof(transa)));
  checkCublasStatus(cublasLtMatmulDescSetAttribute(operationDesc, CUBLASLT_MATMUL_DESC_TRANSB, &transb, sizeof(transa)));
  printf("gemm_bias_lt-half:4\n");
  checkCublasStatus(cublasLtMatmulPreferenceCreate(&preference));
  checkCublasStatus(cublasLtMatmulPreferenceSetAttribute(preference, CUBLASLT_MATMUL_PREF_MAX_WORKSPACE_BYTES, &workspaceSize, sizeof(workspaceSize)));

  checkCublasStatus(cublasLtMatmulAlgoGetHeuristic(ltHandle, operationDesc, Adesc, Bdesc, Cdesc, Cdesc, preference, 1, &heuristicResult, &returnedResults));
  printf("gemm_bias_lt-half:5\n");
  if (returnedResults == 0) { checkCublasStatus(CUBLAS_STATUS_NOT_SUPPORTED);  }
  checkCublasStatus(cublasLtMatmul(ltHandle, operationDesc, alpha, A, Adesc, B, Bdesc, beta, C, Cdesc, C, Cdesc, NULL, workspace, workspaceSize, stream));
  printf("gemm_bias_lt-half:6\n");
  // descriptors are no longer needed as all GPU work was already enqueued
  if (preference) checkCublasStatus(cublasLtMatmulPreferenceDestroy(preference));
  if (Cdesc) checkCublasStatus(cublasLtMatrixLayoutDestroy(Cdesc));
  if (Bdesc) checkCublasStatus(cublasLtMatrixLayoutDestroy(Bdesc));
...
int linear_bias_forward_cuda(at::Tensor input, T *weight, at::Tensor bias, int in_features, int batch_size, int out_features, at::Tensor output, void *lt_workspace)
{
    ...
    printf("linear_bias_forward_cuda:1 status=%d\n",status);
#if defined(CUBLAS_VERSION) && CUBLAS_VERSION >= 11600 || defined(USE_ROCM)
    status = gemm_bias_lt(
...
#endif
    printf("linear_bias_forward_cuda:2 status=%d\n",status);
    /*
    output.copy_(bias);
...
*/
    printf("linear_bias_forward_cuda:3\n");
    return status;
}
...
template  int linear_bias_backward_cuda<at::BFloat16>(at::BFloat16 *, at::BFloat16 *, at::BFloat16 *, int, int, int,  
		                                                 at::BFloat16 *, at::BFloat16 *, at::BFloat16 *, void *);
...
template int linear_gelu_linear_forward_cuda<at::Half>(at::Half *, at::Half *, at::Half *, at::Half *, at::Half *, int, int, int, int, 
		                                                  at::Half *, at::Half *, at::Half *, void *);
template int linear_gelu_linear_forward_cuda<float>(float *, float *, float *, float *, float *, int, int, int, int, float *, float *, float *, void *);
template int linear_gelu_linear_forward_cuda<double>(double *, double *, double *, double *, double *, int, int, int, int,  double *, double *, double *, void *);
...
template int linear_gelu_linear_backward_cuda<at::BFloat16>(at::BFloat16 *, at::BFloat16 *, at::BFloat16 *, at::BFloat16 *, at::BFloat16 *, at::BFloat16 *, 
		                                                       at::BFloat16 *, int, int, int, int, at::BFloat16 *, at::BFloat16 *, at::BFloat16 *,  at::BFloat16 *, 
								       at::BFloat16 *,   void *);
template int linear_gelu_linear_backward_cuda<at::Half>(at::Half *, at::Half *, at::Half *, at::Half *, at::Half *, at::Half *, at::Half *, int, int, int, int, 
		                                                   at::Half *, at::Half *, at::Half *, at::Half *, at::Half *, void *);
template int linear_gelu_linear_backward_cuda<float>(float *, float *, float *, float *, float *, float *, float *, int, int, int, int, float *,
                                                          	float *, float *, float *, float *, void *);
template int linear_gelu_linear_backward_cuda<double>(double *, double *, double *, double *, double *, double *, double *, int, int, int, int,  double *, 
