...
class NhwcBatchNormAddRelu {
 public:
  ...
  void fwd(hipStream_t stream, void* my_data, void* pair_data, void* pair_data2, void* pair_data3, const int bn_group, const int magic, const int occupancy, const int grid_dim_x, const bool coop);
  void dgrad(hipStream_t stream, void* my_data, void* pair_data, void* pair_data2, void* pair_data3, const int bn_group, const int magic, const int occupancy, const int grid_dim_x, const bool coop);
  void fwdInference(hipStream_t stream);
...
#undef LAUNCH_FWD_KERNEL
  ...
  void _bwdKernelLauncher(hipStream_t stream, NhwcBatchNormBwdParams params,
                                dim3 grid_dim, int outer_loops, const int occupancy, const bool coop) {
...
void NhwcBatchNormAddRelu::fwdInference(hipStream_t stream) {
  bool ptrs_are_set =
...
void NhwcBatchNormAddRelu::fwd(hipStream_t stream, void* my_data, void* pair_data, void* pair_data2, void* pair_data3,
...
void NhwcBatchNormAddRelu::dgrad(hipStream_t stream, void* my_data, void* pair_data, void* pair_data2, void* pair_data3,
                                 const int bn_group, const int magic, const int occupancy, const int grid_dim_x, const bool coop) {
  bool ptrs_are_set =
      X_tensor_desc_ != nullptr
      && Y_tensor_desc_ != nullptr
